...
export default function ExploreMoreCourses() {
  ...
  return (
    <div className="mt-6 lg:mt-8 lg:mb-20 mb-6">
      {/* Header */}
      ...
      <div className="overflow-hidden">
        <div
          ...
          style={{
            transform: `translateX(calc(-${current} * (100% / ${VISIBLE} + 20px / ${VISIBLE} * (${VISIBLE} - 1) / ${VISIBLE})))`,
          }}
        >
          {COURSES.map((course, i) => (
            ...
            >
              ...
              <Image
                src={course.image}
                alt={course.title}
                className="object-cover rounded-lg  w-92 h-65.5 "
              />
              ...
              <div className="p-4 flex flex-col gap-2 flex-1">
                ...
                <div className="flex items-center justify-between mt-auto pt-3  ">
                  ...
                  <button
                    className={`px-4 py-1.5 rounded-md h-10 cursor-pointer text-sm font-semibold transition-colors ${
                      i === current
