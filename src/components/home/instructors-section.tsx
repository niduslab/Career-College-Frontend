...
export function InstructorsSection() {
  return (
    <section className="relative mt-10 w-full overflow-hidden bg-[#2E076E] py-12 md:py-16 lg:mt-25 lg:py-20">
      <div
      ...
      <div className="relative z-10 mx-auto w-full max-w-310 px-4 md:px-6 lg:px-8">
        <h2 className="text-center text-[34px] leading-[1.12] font-semibold tracking-[-0.03em] text-(--text-white) md:text-[42px] lg:text-[48px]">
          Learn from the Minds
          <br />
          Behind Real-World Success
        </h2>

        <div className="mt-8 grid gap-4 md:mt-10 md:grid-cols-2 lg:mt-12 lg:grid-cols-4 lg:gap-5">
          {INSTRUCTORS.map((instructor) => (
            <article key={instructor.name} className="group">
              <div className="aspect-4/5 overflow-hidden rounded-2xl md:aspect-auto">
                <Image
