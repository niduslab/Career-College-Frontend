...
const allData: Record<string, { months: string[]; values: number[] }> = {
  "3 months": {
    months: ["Apr", "May", "Jun"],
    values: [42800, 46200, 48920],
  },
  "4 months": {
    months: ["Mar", "Apr", "May", "Jun"],
    values: [39400, 42800, 46200, 48920],
  },
  "5 months": {
    months: ["Feb", "Mar", "Apr", "May", "Jun"],
    values: [35600, 39400, 42800, 46200, 48920],
  },
  "6 months": {
    months: ["Jan", "Feb", "Mar", "Apr", "May", "Jun"],
    values: [31200, 35600, 39400, 42800, 46200, 48920],
  },
};
...
const Y_LABELS = [0, 12500, 25000, 37500, 50000];
const MAX_VAL = 50000;
const W = 560;
const H = 240;
