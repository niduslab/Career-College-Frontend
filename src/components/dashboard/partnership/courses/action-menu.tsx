...
import { MoreHorizontal, Pencil, Eye, Trash2, Globe, EyeOff, Copy } from "lucide-react";
...
export default function CourseActionMenu({ open, onToggle, setRef }: ActionMenuProps) {
