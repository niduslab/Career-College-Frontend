...
import { MoreHorizontal, Pencil, Eye, Trash2, PlayCircle, Copy } from "lucide-react";
...
export default function WebinarActionMenu({ open, onToggle, setRef }: ActionMenuProps) {
  ...
  const items = [
    ...
    { icon: PlayCircle, label: "Watch Recording" },
