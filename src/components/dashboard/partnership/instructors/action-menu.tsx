...
import { MoreHorizontal, Pencil, Eye, Trash2, Send, UserX } from "lucide-react";
...
export default function InstructorActionMenu({ open, onToggle, setRef }: ActionMenuProps) {
  ...
  const items = [
    ...
    { icon: Send, label: "Re-invite" },
    { icon: UserX, label: "Deactivate", danger: true },
