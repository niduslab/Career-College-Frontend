...
function ProfileTab() {
  const [form, setForm] = useState({
    ...
    organization: "NidusLab Technologies",
    role: "Partnership Manager",
    bio: "Building strategic partnerships to expand access to professional education.",
    website: "https://niduslab.com",
    linkedin: "linkedin.com/in/alamin-hossain",
    twitter: "@alamin_hossain",
  });
    ...
    <div className="space-y-4">
      ...
      <SectionCard title="Profile Photo">
        <div className="flex items-center gap-5">
          <div className="relative">
            <div className="w-18 h-18 rounded-full bg-(--primary-100) text-(--primary-700) text-[24px] font-semibold flex items-center justify-center shrink-0">
              AH
            </div>
            <button
              type="button"
      ...
      <SectionCard
        ...
        description="This is displayed on your public partnership profile."
      >
          ...
          <div className="sm:col-span-2">
            <Field label="Bio">
              <textarea
                ...
                onChange={set("bio")}
                rows={3}
                placeholder="Briefly describe your partnership focus…"
                className="w-full px-3 py-2.5 text-[14px] border border-(--gray-200) rounded-lg bg-white text-(--text-title) placeholder:text-(--gray-400) outline-none focus:ring-2 focus:ring-(--primary-700) transition-shadow"
              />
            </Field>
          </div>
        </div>
            ...
            return (
              <React.Fragment key={id}>
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-md text-[14px]  transition-colors cursor-pointer whitespace-nowrap ${
                    active
                      ? "bg-(--primary-600) text-white font-medium hover:bg-(--primary-700)"
                      : "text-(--gray-500) hover:text-(--text-title) font-normal"
                  }`}
                >
                  <Icon
