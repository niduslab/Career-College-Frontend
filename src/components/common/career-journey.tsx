      ...
      <div className="mx-auto grid w-full max-w-310 items-stretch gap-8 rounded-[28px] p-4 md:gap-10 md:p-6 lg:grid-cols-[1fr_1.02fr] lg:gap-10 lg:p-8">
        ...
        >
          <Image
            ...
            width={610}
            height={625}
            className="h-90 w-full  fill rounded-2xl object-cover md:h-137.5 lg:h-full lg:min-h-156.2"
          /> */}
        <div
          ref={imageRef}
          className="relative h-90 w-full rounded-2xl md:h-137.5 lg:h-full lg:min-h-156.2"
        >
          <Image
            src={image}
            alt="Student focused on online learning"
        ...
        <div
          ref={contentRef}
          className="flex h-full max-w-145 flex-col justify-between"
        >
          <div>
